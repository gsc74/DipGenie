...
def par_run_PHI(read_cov_pair):
    ...
    output_file = f"data/Rec_haps/rec_hap_{read}_{cov}x_7_2.fa"
    log_file = f"data/Rec_haps/rec_hap_{read}_{cov}x_7_2.log"
    ground_truth = f"Ground_truth/{read}.fasta"
    
    cmd = (
        f"PHI -q1 -m1 -R100 -k31 -w25 -t{running_threads} "
        f"-g data/MHC_7-MC_30_2.gfa -r {downsampled_read} "
